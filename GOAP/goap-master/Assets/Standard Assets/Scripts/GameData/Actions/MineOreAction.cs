...
public class MineOreAction : GoapAction
{
	...
	public override bool checkProceduralPrecondition (GameObject agent)
	{
        ...
        IronRockComponent[] rocks = (IronRockComponent[]) UnityEngine.GameObject.FindObjectsOfType ( typeof(IronRockComponent) );
		IronRockComponent closest = null;
		float closestDist = 0;

        /*if (rocks.Length == 0) //doesn't seem to work
        {
            Labourer dude = GetComponent<Labourer>();
            dude.planAborted(null);
        }*/
